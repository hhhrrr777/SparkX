...
INSERT INTO "public"."system_users" ("user_id", "name", "nickname", "avatar", "password", "salt", "deleted", "status", "create_time", "update_time") VALUES ('b6c67084-ad55-4ced-82c4-4d9d304e8616', '', '管理员', '', 'a6538e80c90c6bd00cf838a862020c31', '67bb1f3dca25ffc420f04d2e', 1, 1, '2025-02-23 21:14:37', '2025-02-23 23:11:03');
...
INSERT INTO "public"."models" VALUES ('5f6f2e21-df9b-418d-a54b-ed271g6cf6c5', '智普AI', 'zhipu', 1, '[{"field":"apiKey","value":""}]', '[{"field":"temperature","name":"温度","range":[0.01,1],"value":0.95}]', 1, 'glm-4,glm-4v,glm-4-0520,glm-4-air,glm-4-airx,glm-4-flash', '/icons/zhipu.png', '', '2025-07-01 10:36:08', NULL);
INSERT INTO "public"."models" VALUES ('5f6f2e31-df9b-418d-a56b-ed271g8cf7c6', '通义千问', 'qwen', 1, '[{"field":"apiKey","value":""}]', '[{"field":"temperature","name":"温度","range":[0.01,1],"value":0.95},{"field":"url","name":"模型地址","value": "https://dashscope.aliyuncs.com/compatible-mode/v1"}]', 1, 'qwen-plus,qwen-turbo,qwen-max,qwen-long', '/icons/qwen.png', 'qwen-plus,qwen-turbo,qwen-max', '2025-07-01 13:56:11', NULL);
INSERT INTO "public"."models" VALUES ('5f7f2e32-df7b-428d-a56b-ed272f9cf7c8', '字节豆包', 'doubao', 1, '[{"field":"apiKey","value":""}]', '[{"field":"temperature","name":"温度","range":[0.01,1],"value":0.95}, {"field":"url","name":"模型地址","value": "https://ark.cn-beijing.volces.com/api/v3"}]', 1, 'doubao-1-5-pro-32k-250115,doubao-1-5-pro-256k-250115', '/icons/doubao.png', 'doubao-1-5-pro-32k-250115,doubao-1-5-pro-256k-250115', '2025-07-02 10:40:08', NULL);
INSERT INTO "public"."models" VALUES ('5f6f2e31-df9b-419d-a56b-ed281g6cf8c9', 'GPT', 'gpt', 1, '[{"field":"apiKey","value":""}]', '[{"field":"temperature","name":"温度","range":[0.01,1],"value":0.95},{"field":"url","name":"模型地址","value": "https://api.fireaigc.cn/v1"}]', 1, 'gpt-3.5-turbo,gpt-4o', '/icons/gpt.png', 'gpt-3.5-turbo,gpt-4o', '2025-07-02 13:48:13', NULL);
