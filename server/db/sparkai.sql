...
INSERT INTO "public"."models" VALUES ('5f6f2e21-df9b-418d-a54b-ed271g6cf6c5', '智普AI', 'zhipu', 1, '[{"field":"apiKey","value":""}]', '[{"field":"temperature","name":"温度","range":[0.01,1],"value":0.95}]', 1, 'glm-4,glm-4v,glm-4-0520,glm-4-air,glm-4-airx,glm-4-flash,glm-3-turbo,chatglm_turbo', '/icons/zhipu.png', 'glm-4,glm-4v,glm-4-0520,glm-4-air,glm-4-airx,glm-4-flash', '2025-07-01 10:36:08', NULL);
INSERT INTO "public"."models" VALUES ('5f6f2e31-df9b-418d-a56b-ed271g8cf7c6', '通义千问', 'qwen', 1, '[{"field":"apiKey","value":""}]', '[{"field":"temperature","name":"温度","range":[0.01,1],"value":0.95}]', 1, 'qwen-plus,qwen-turbo,qwen-max,qwen-long', '/icons/qwen.png', 'qwen-plus,qwen-turbo,qwen-max', '2025-07-01 13:56:11', NULL);
