...
COMMENT ON COLUMN "public"."system_users"."id" IS 'id';
COMMENT ON COLUMN "public"."system_users"."name" IS '登录账号';
COMMENT ON COLUMN "public"."system_users"."code" IS '唯一编码';
...
COMMENT ON COLUMN "public"."knowledge_dataset"."id" IS 'id';
...
COMMENT ON COLUMN "public"."knowledge_paragraph"."id" IS 'id';
...
COMMENT ON COLUMN "public"."knowledge_embedding"."id" IS 'id';
...
CREATE TABLE "public"."knowledge_question" (
    ...
    "create_time" timestamp(6),
    "update_time" timestamp(6),
    CONSTRAINT "knowledge_question_pkey" PRIMARY KEY ("id")
);
...
COMMENT ON COLUMN "public"."knowledge_question"."id" IS 'id';
...
CREATE TABLE "public"."knowledge_question_paragraph" (
    ...
    "create_time" timestamp(6),
    "update_time" timestamp(6),
    CONSTRAINT "knowledge_question_paragraph_relation_pkey" PRIMARY KEY ("id")
);
...
COMMENT ON COLUMN "public"."knowledge_question_paragraph"."id" IS 'id';
