...
INSERT INTO "public"."models" VALUES ('6f4f2e11-df9b-418d-a64b-ed272b6cf5c5', '百度千帆', 'qianfan', 3, '[{"field":"apiKey","value":""}]', '[{"field":"url","name":"模型地址","value":"https://qianfan.baidubce.com/v2/rerank"}]', 1, 'bge-reranker-v2-m3', '/icons/baidu.png', '', '2025-03-30 21:22:35', '2025-07-19 11:34:34');
INSERT INTO "public"."models" VALUES ('6f4f2e28-df9e-419f-a65c-ed272b6cf5e9', '通义千问', 'qwen', 3, '[{"field":"apiKey","value":""}]', '[{"field":"url","name":"模型地址","value":"https://dashscope.aliyuncs.com/api/v1/services/rerank/text-rerank/text-rerank"}]', 1, 'gte-rerank-v2', '/icons/qwen.png', '', '2025-03-30 21:22:35', '2025-07-03 20:57:33');
INSERT INTO "public"."models" VALUES ('6f4f2e21-df9d-419d-a65b-ed272b6cf5c8', '智普AI', 'zhipu', 3, '[{"field":"apiKey","value":""}]', '[{"field":"url","name":"模型地址","value": "https://open.bigmodel.cn/api/paas/v4/rerank"}]', 1, 'rerank', '/icons/zhipu.png', '', '2025-03-30 21:22:35', '2025-07-19 11:44:50');
